/*=====================================================================================*\
| Author:   Christopher Coyne                                      February 27th, 2021  |
| --------------------------------------------------------------------------------------|
| MODULE:     [ Main ]                                                                  |
| --------------------------------------------------------------------------------------|
| DESCRIPTION:                                                                          |
...
#include <LiquidCrystal_I2C.h> // Library for LCD screens
...
void loop() {
  ...
  if ((prev_start == 1 && now_start == 0) || (prev_start == 0 && now_start == 1)) {
    ...
    /*-------------------------------------------------------------------------------------------*/
    /* ACCELERATION PHASE                                                                        */
    /* 1. Accelerate to speed per user selections                                                */
    /* 2. Write to the screen to alert user to acceleration                                      */
    /*-------------------------------------------------------------------------------------------*/
    ...
    /* 1. Beep to signal the end of the acceleration phase and beginning of constant-speed phase */
    /*-------------------------------------------------------------------------------------------*/
    ...
    // Otherwise, conduct the constant speed phase as normal
      ...
      for (int i = 1; i <= TEST_write; i++) {
        ...
        if (PWM_signal >= 255) { PWM_signal = 255; }
        analogWrite(PWM, PWM_signal);
    ...
    /*-------------------------------------------------------------------------------------------*/
    /* DECELERATION PHASE                                                                        */
    /* 1. Decelerate per user input                                                              */
    /* 2. Write to the screen to alert user to deceleration                                      */
    /*-------------------------------------------------------------------------------------------*/
